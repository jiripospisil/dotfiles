" Vim Syntax File
" Language: C Standard functions and constants (with some extensions)
...
syntax keyword std_constant ATOMIC_POINTER_LOCK_FREE
syntax keyword std_constant ATOMIC_CHAR32_T_LOCK_FREE
syntax keyword std_constant ATOMIC_CHAR16_T_LOCK_FREE
syntax keyword std_constant ATOMIC_WCHAR_T_LOCK_FREE
syntax keyword std_constant ATOMIC_LLONG_LOCK_FREE
syntax keyword std_constant ATOMIC_SHORT_LOCK_FREE
syntax keyword std_constant ATOMIC_LONG_LOCK_FREE
syntax keyword std_constant ATOMIC_CHAR_LOCK_FREE
syntax keyword std_constant ATOMIC_BOOL_LOCK_FREE
syntax keyword std_constant ATOMIC_INT_LOCK_FREE

syntax keyword std_constant ATOMIC_FLAG_INIT
syntax keyword std_constant ATOMIC_VAR_INIT

syntax keyword std_constant kill_dependency

" types
syntax keyword std_type memory_order

syntax keyword std_constant memory_order_relaxed
syntax keyword std_constant memory_order_consume
syntax keyword std_constant memory_order_acquire
syntax keyword std_constant memory_order_release
syntax keyword std_constant memory_order_acq_rel
syntax keyword std_constant memory_order_seq_cst
...
" typedefs
syntax keyword std_type atomic_bool
syntax keyword std_type atomic_char
syntax keyword std_type atomic_schar
syntax keyword std_type atomic_uchar
syntax keyword std_type atomic_short
syntax keyword std_type atomic_ushort
syntax keyword std_type atomic_int
syntax keyword std_type atomic_uint
syntax keyword std_type atomic_long
syntax keyword std_type atomic_ulong
syntax keyword std_type atomic_llong
syntax keyword std_type atomic_ullong
syntax keyword std_type atomic_char16_t
syntax keyword std_type atomic_char32_t
syntax keyword std_type atomic_wchar_t 
syntax keyword std_type atomic_int_least8_t
syntax keyword std_type atomic_uint_least8_t
syntax keyword std_type atomic_int_least16_t
syntax keyword std_type atomic_uint_least16_t
syntax keyword std_type atomic_int_least32_t
syntax keyword std_type atomic_uint_least32_t
syntax keyword std_type atomic_int_least64_t
syntax keyword std_type atomic_uint_least64_t
syntax keyword std_type atomic_int_fast8_t
syntax keyword std_type atomic_uint_fast8_t
syntax keyword std_type atomic_int_fast16_t
syntax keyword std_type atomic_uint_fast16_t
syntax keyword std_type atomic_int_fast32_t
syntax keyword std_type atomic_uint_fast32_t
syntax keyword std_type atomic_int_fast64_t
syntax keyword std_type atomic_uint_fast64_t
syntax keyword std_type atomic_intptr_t
syntax keyword std_type atomic_uintptr_t
syntax keyword std_type atomic_size_t
syntax keyword std_type atomic_ptrdiff_t
syntax keyword std_type atomic_intmax_t
syntax keyword std_type atomic_uintmax_t
